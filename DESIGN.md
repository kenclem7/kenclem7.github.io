...
- The h1's forecast phrase is one unbreakable unit - "Daily Weather Forecast" / "3 Day Weather Forecast" / "10 Day Weather Forecast" never break internally (runtime nbsp on every internal space, 2026-08-18, generator-safe): a long city name wraps BEFORE the whole phrase ("...near Jersey (JE) / 3 Day Weather Forecast").
